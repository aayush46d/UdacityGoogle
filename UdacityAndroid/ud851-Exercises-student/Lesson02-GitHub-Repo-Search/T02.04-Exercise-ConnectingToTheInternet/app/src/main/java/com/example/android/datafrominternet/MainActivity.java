...
public class MainActivity extends AppCompatActivity {
    ...
    private void makeGithubSearchQuery() {
        ...
        String githubSeatchResults=null;
        try{
            githubSeatchResults=NetworkUtils.getResponseFromHttpUrl(githubSearchUrl);
            mSearchResultsTextView.setText(githubSeatchResults.toString());
        } catch (IOException e){
            e.printStackTrace();
        }
    }
